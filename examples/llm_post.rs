...
async fn main() -> Result<()> {
    ...
    let messages = vec![
        Message {
            role: "system".into(),
            content: Some("你是一个 Rust 专家，回答简洁，代码示例不超过 15 行。".into()),
            tool_call_id: None,
            tool_calls: None,
        },
        Message {
            role: "user".into(),
            content: Some("Rust 中 ? 操作符的原理是什么？".into()),
            tool_call_id: None,
            tool_calls: None,
        },
    ];
    ...
    let messages = vec![
        Message {
            role: "system".into(),
            content: Some("你是一个 Rust 专家，回答简洁。".into()),
            tool_call_id: None,
            tool_calls: None,
        },
        Message {
            role: "user".into(),
            content: Some("用三句话解释 Rust 的所有权系统。".into()),
            tool_call_id: None,
            tool_calls: None,
        },
    ];
